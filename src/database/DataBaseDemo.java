 ...
 *To work with database we have gather the following infromation
 ...
 5. Table Name on which we want to perfrom the operations
...
public class DataBaseDemo {
    ...
    public static void main(String[] args) {
    	...
    	try {
	         ...
	         */
			ResultSet rs = statement.executeQuery("select * from city where CountryCode = 'IND' and District = 'Andhra Pradesh'");
			...
			while(rs.next()) {
				...
				System.out.println(id+"\t"+name+"\t"+cc+"\t"+district+"\t"+population);
